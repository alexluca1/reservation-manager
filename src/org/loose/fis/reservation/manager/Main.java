...
public class Main {
    ...
    public static void main(String[] args) {
        //creating the users
        User user1 = new User( firstName: "John", lastName: "Doe", 43);
        User user2 = new User( firstName: "Angelina", lastName: "Clooney", 25);
        User user3 = new User( firstName: "George", lastName: "Jackson", 58);
        User user4 = new User( firstName: "Francesca", lastName: "Jolie", 19);
